...
def make_display():
    ...
    display_bus = displayio.FourWire(spi, command=board.D9, chip_select=board.D5, reset=board.D7)

    return ST7789(display_bus, width=128, height=128, rowstart=80, auto_refresh=True)
